...
- moved translation function to saori.php
- removed overflow: hidden from some comment styles
- cleaned up head with more removals
- moved related posts & page navi plugin to saori.php
...
- added post formats to saori.php core
...
- fixed error in saori.php for menu fallback **thanks Mark**
